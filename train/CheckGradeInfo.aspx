<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckGradeInfo.aspx.cs" Inherits="DigitalSystem.train.CheckGradeInfo" %>
    ...
    <div>
        ...
        <div>
            <dx:ASPxPageControl ID="ASPxPageControl2" runat="server" ActiveTabIndex="0" width="100%">
              <TabPages>
                    <dx:TabPage Text="成绩审核" >
                                <ContentCollection>
                                          <dx:ContentControl>
        <dx:ASPxGridView ID="ASPxGridViewForDepot" runat="server" AutoGenerateColumns="False" ClientIDMode="AutoID" DataSourceID="Employee_Course_View" Width="100%" KeyFieldName="Id">
                     ...
                     <td>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="style2"></td>
                                        <td align="right">
                                            <dx:ASPxButton ID="btnSave" runat="server" Text="通过" Width="80px"  AutoPostBack="true" OnClick="Pass_Click">
                                        ...
                                        <td>
                                            <dx:ASPxButton ID="btnDelete" runat="server" Text="驳回" Width="100px"
                                                Style="margin-left: 0px" ClientIDMode="AutoID" OnClick="No_Pass_Click" >
       ...
       <asp:HiddenField ID="hide_department_id" runat="server" />
        ...
        <asp:LinqDataSource ID="LinqDataSourceUser" runat="server" ContextTypeName="DigitalSystem.dbDataContext" EntityTypeName="" TableName="S_User_Info" Select="new (id, UserName)">
         ...
         <asp:LinqDataSource ID="Employee_train_record" runat="server" ContextTypeName="DigitalSystem.train.train_courseDataContext" EnableDelete="True" EnableInsert="True" EnableUpdate="True" TableName="Employee_train_record" Where="Course_id == @Course_id">
            ...
            <asp:LinqDataSource ID="User_info_select_by_Departmet" runat="server" ContextTypeName="DigitalSystem.dbDataContext" TableName="S_User_Info" Select="new (DepartmentId, id, UserName)">
            </asp:LinqDataSource>
        </div>
                        </dx:SplitterContentControl> 
                    </ContentCollection>
