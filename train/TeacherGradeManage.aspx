<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherGradeManage.aspx.cs" Inherits="DigitalSystem.train.TeacherGradeManage" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <style type="text/css">
        ...
        <script type="text/javascript">
            function btnNew_Click(s, e) {
                ...
                mainsplitter.GetPaneByName('right').SetContentUrl("TeacherGradeRedirect.aspx?pageAttr=edit&Id=-1");
            ...
            function OnGetSelectedFieldValues(values) {
                mainsplitter.GetPaneByName('right').SetContentUrl("TeacherGradeRedirect.aspx?pageAttr=edit&Id=" + values[0]);
    ...
    <form id="form1" runat="server">
        <div  style="overflow:scroll; position:relative; top:0px; width:100%; height:100%; left:0px;" runat="server">
            ...
            <dx:ASPxSplitter ID="mainsplitter"  ClientInstanceName="mainsplitter" runat="server" Height="1000px"   Width="100%" FullscreenMode="True" Style="margin-bottom: 0px" ClientIDMode="AutoID"   >
                ...
                <Panes>
                    ...
                    <dx:SplitterPane Name="right" ContentUrl="blank.aspx" ScrollBars="Auto"  ShowCollapseBackwardButton="True"  ShowCollapseForwardButton="True">
                        <ContentCollection>
        ...
        <div>
            <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="DigitalSystem.train.train_courseDataContext" EntityTypeName="" TableName="train_course_view" Where="Teacher == @Teacher &amp;&amp; Status == @Status or Status==@Status1">
                <WhereParameters>
                    <asp:SessionParameter DefaultValue="0" Name="Teacher" SessionField="user_id" Type="Int32" />
                    <asp:Parameter DefaultValue="1" Name="Status" Type="Int32" />
                    <asp:Parameter DefaultValue="4" Name="Status1" Type="Int32" />
                </WhereParameters>
            </asp:LinqDataSource>
