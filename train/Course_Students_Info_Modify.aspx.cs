...
{
    public partial class Course_Students_Info_Modify : System.Web.UI.Page
    {
        ...
        //    info.End_choose_date = EndChooseDate.Date;
        ...
        private void insert_Employee_Train_Record(int userId)
        {
            if (!getUserByUserIdAndCouresId(userId, Convert.ToInt32(Request["Id"]))) return;
            Employee_train_record r = new Employee_train_record();
            r.Course_id = Convert.ToInt32(Request["Id"]);
            r.Employee_id = userId;
            r.Remark = 3;
        ...
        private bool getUserByUserIdAndCouresId(int userid, int courseId)
        {
        ...
        protected void AddSingleEmployeeDepartmentId_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            int provenceId = Convert.ToInt32(AddSingleEmployeeDepartmentId.Value);
            hide_department_id.Value = provenceId.ToString();
            AddSingleEmployeeUserId.DataBind();
            AddSingleEmployeeUserId.Enabled = true;
            //AddSingleEmployeeUserId.Text = "";
        ...
        {
            //ASPxGridView1.DataBind();
           // ErrorMessage.Text = "HHHHH";
            //Response.Write("<script language=javascript>window.location.href=document.URL;</script>");
        }

        protected void ASPxPageControl2_TabClick(object source, DevExpress.Web.ASPxTabControl.TabControlCancelEventArgs e)
        {
            //ASPxGridView1.DataBind();
        }
