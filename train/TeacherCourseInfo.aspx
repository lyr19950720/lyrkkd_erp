<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherCourseInfo.aspx.cs" Inherits="DigitalSystem.train.TeacherCourseInfo" %>
                    ...
                    <dx:TabPage Text="学员名单">
                                <ContentCollection>
                                          <dx:ContentControl >
                                              ...
                                              <dx:ASPxGridView ID="ASPxGridView2" runat="server" AutoGenerateColumns="False" ClientIDMode="AutoID" DataSourceID="Employee_train_record" Width="100%" KeyFieldName="Id" OnHtmlRowPrepared="ASPxGridView3_HtmlRowPrepared">
            ...
            <Columns>
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td align="center">
                                            <dx:ASPxButton ID="UploadGrade" runat="server" Text="提交审核" Width="80px"  AutoPostBack="true" OnClick="btn_upload_grade">
                                            </dx:ASPxButton>
                                        </td>
