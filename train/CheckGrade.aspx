<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckGrade.aspx.cs" Inherits="DigitalSystem.train.CheckGrade" %>
    ...
    <style type="text/css">
        ...
        <script type="text/javascript">
            function btnNew_Click(s, e) {
                ...
                mainsplitter.GetPaneByName('right').SetContentUrl("CheckGradeRedirect.aspx?pageAttr=edit&Id=-1");
            ...
            function OnGetSelectedFieldValues(values) {
                mainsplitter.GetPaneByName('right').SetContentUrl("CheckGradeRedirect.aspx?pageAttr=edit&Id=" + values[0]);
            ...
            <dx:ASPxSplitter ID="mainsplitter" runat="server" ClientInstanceName="mainsplitter" 
                ...
                <Panes>
                    ...
                    <dx:SplitterPane Name="left" ScrollBars="Auto" ShowCollapseBackwardButton="True"
                        ...
                        <Panes>
                          <dx:SplitterPane Name="newProject" Size="30%">
                                <ContentCollection>
                          ...
                          <%--                      <td>
                                                ...
                                                <td>
                                                    <dx:ASPxButton ID="RefreshBtn" runat="server" ClientIDMode="AutoID" Text="刷新" ClientInstanceName="RefreshBtn" OnClick="RefreshBtn_Click"
                                                        Height="1px"  ClientVisible ="false">
                                        ...
                                        <dx:ASPxGridView ID="gridEditList" runat="server" DataSourceID="LinqDataSource1"  ClientInstanceName="gridEditList" Width="100%" 
                                                       AutoGenerateColumns="False" ClientIDMode="AutoID" Caption="待审核课程" KeyFieldName="Id">
                          ...
                          <dx:SplitterPane Name="editProject" ScrollBars="Auto" Size="50%">
                                <ContentCollection>
                                    ...
                                    <dx:SplitterContentControl ID="SplitterContentControl3" runat="server" SupportsDisabledAttribute="True">
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <dx:ASPxButton ID="RefreshBtn1" runat="server" ClientIDMode="AutoID" Text="刷新" ClientInstanceName="RefreshBtn" OnClick="RefreshBtn_Click"
                                                        Height="1px"  ClientVisible ="false">
                                                        <ClientSideEvents   Click="function(s,e){e.processOnServer=true;}"/>
                                                    </dx:ASPxButton>
                                                </td>
                                                ...
                                                <dx:ASPxGridView ID="gridEditList1" runat="server" DataSourceID="LinqDataSource2"  ClientInstanceName="gridEditList" Width="100%" 
                                                       AutoGenerateColumns="False" ClientIDMode="AutoID" Caption="通过或者驳回课程" KeyFieldName="Id">
                                                   <%-- <ClientSideEvents SelectionChanged="gridEditList_SelectionChanged" />--%>
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn FieldName="Id" ReadOnly="True" VisibleIndex="6" Visible="false">
                                                    </dx:GridViewDataTextColumn>
