<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studentType.aspx.cs" Inherits="DigitalSystem.train.floder.studentType" %>
...
<body>
    ...
    <div>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="Name" VisibleIndex="1" Caption="名称">
                </dx:GridViewDataTextColumn>
    ...
    <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="DigitalSystem.train.train_courseDataContext" EnableInsert="True" EnableUpdate="True" EntityTypeName="" TableName="train_student_status" EnableViewState="False"></asp:LinqDataSource>
</body>
</html>