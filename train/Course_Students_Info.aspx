<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Course_Students_Info.aspx.cs" Inherits="DigitalSystem.train.Course_Students_Info" %>
    ...
    <style type="text/css">
        ...
        <script type="text/javascript">
            ...
            function OnGetSelectedFieldValues(values) {
                //mainsplitter.GetPaneByName('right').SetContentUrl("trainRedirect.aspx?pageAttr=edit&Id=" + values[0]);
                mainsplitter.GetPaneByName('right').SetContentUrl("Course_Students_Info_Modify.aspx?Id=" + values[0]);
